...
CREATE TABLE equipos (
    ...
    logo LONGTEXT COMMENT 'Ruta a la imagen del logo. Por ahora puesto como null',
...
CREATE TABLE pilotos (
    ...
    foto LONGTEXT COMMENT 'Ruta a la foto del piloto',
...
CREATE TABLE circuitos (
    ...
    pais VARCHAR(100) NOT NULL,
    calendario BOOLEAN,
    trazado LONGTEXT COMMENT 'Ruta a la imagen del trazado',
...
CREATE TABLE noticias (
    ...
    imagen LONGTEXT COMMENT 'Ruta a la imagen',
